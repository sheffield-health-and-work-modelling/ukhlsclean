...
clean_work <- function(data = NULL,
  ...
  data[jbsic07_cc %in% 1:3, sic_1dig := "Agriculture, forestry and fishing"]
  data[jbsic07_cc %in% 5:9, sic_1dig := "Mining and quarrying"]
  data[jbsic07_cc %in% 10:33, sic_1dig := "Manufacturing"]
  data[jbsic07_cc %in% 35:39, sic_1dig := "Utilities"]
  data[jbsic07_cc %in% 41:43, sic_1dig := "Construction"]
  data[jbsic07_cc %in% 45, sic_1dig := "Motor trades"]
  data[jbsic07_cc %in% 46, sic_1dig := "Wholesale trade"]
  data[jbsic07_cc %in% 47, sic_1dig := "Retail trade"]
  data[jbsic07_cc %in% 49:53, sic_1dig := "Transport and storage"]
  data[jbsic07_cc %in% 55:56, sic_1dig := "Accommodation and food services"]
  data[jbsic07_cc %in% 58:63, sic_1dig := "Information and communication"]
  data[jbsic07_cc %in% 64:66, sic_1dig := "Finance and insurance"]
  data[jbsic07_cc %in% 68, sic_1dig := "Property"]
  data[jbsic07_cc %in% 69:75, sic_1dig := "Professional, scientific, and technical"]
  data[jbsic07_cc %in% 77:82, sic_1dig := "Business admin and support services"]
  data[jbsic07_cc %in% 84, sic_1dig := "Public administration"]
  data[jbsic07_cc %in% 85, sic_1dig := "Education"]
  data[jbsic07_cc %in% 86:88, sic_1dig := "Health"]
  data[jbsic07_cc %in% 90:93, sic_1dig := "Arts, entertainment, and recreation"]
  data[jbsic07_cc %in% 94:99, sic_1dig := "Other"]
  ...
  data[, nssec_8cat := factor(jbnssec8_dv,
                              levels = 1:8,
  ...
  data[, nssec_5cat := factor(jbnssec5_dv,
                              levels = 1:5,
  ...
  data[, nssec_3cat := factor(jbnssec3_dv,
                              levels = 1:3,
                              labels = c("management and professional",
                                         "intermediate",
                                         "routine"))]
